                                ...
                                <div class="profile-info">
									...
									<div class="profile-details">
										<div class="profile-name px-3 pt-2">
											<h4 class="text-primary mb-0">{{userInfo.nom}} {{userInfo.prenom}}</h4>
											<p>{{userInformatons.role}}</p>
										</div>
										<div class="profile-email px-2 pt-2">
											<h4 class="text-muted mb-0">{{userInfo.email}}</h4>
											<p>Email</p>
										</div>
									...
									<div class="card-body">
										<div class="profile-statistics">
											<div class="text-center">
												<div class="row">
													<div class="col">
														<h3 class="m-b-0">{{userInformatons.aff}}</h3><span>Projets</span>
													</div>
													<div class="col">
														<h3 class="m-b-0">Statut</h3><span>{{userInfo.statut}}</span>
													</div>
													<div class="col">
														<h3 class="m-b-0">NDA</h3><span>{{userInfo.nda}}</span>
													</div>
												</div>
												<div class="mt-4">
	...
	export default {
		...
		methods: {
			async getData(){
                ...
                await axios.get('http://127.0.0.1:8000/Userinfo/'+id).then(res => this.userInfo = JSON.parse(res.data))
                console.log(this.userInfo)
                
            },
            async GetUserInformations(){
                var id = this.$route.query.id
                await axios.get('http://127.0.0.1:8000/GetUserinformationnumbers/'+id).then(res => this.userInformatons = JSON.parse(res.data))
                console.log(this.userInformatons)
            }
		},
		beforeMount(){
            this.getData(),
