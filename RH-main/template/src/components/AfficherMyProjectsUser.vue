                    ...
                    <ul class="metismenu" id="menu">
                        <li><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><button @click="redirection(0)">Dashboard</button></li>
                                <br>
                                <li><button @click="redirection(1)">Mes projets</button></li>
                            </ul>
                        </li>
                        <li v-show="user.statut !=='Signed'">

                            <div class="copyright">
                                <p><strong>Contrat non signé</strong></p>
                                <v-btn
                                        depressed
                                        color="error"
                                        @click="signContract"
                            ...
                            <div class="card-body p-0" style="">
                                ...
                                <div class="row border-bottom mx-0 pt-4 px-2 align-items-center ">
                                    <div class="col-xl-3 col-xxl-4 col-lg-6 col-sm-12 mb-sm-4 mb-3 align-items-center  media">
                                        <img class="mr-sm-4 mr-3 img-fluid rounded" width="90" v-bind:src="'http://127.0.0.1:8000/'+item.photoPro" alt="DexignZone" style="width: 200px; height: 200px;">
                                        <div class="media-body" style="">
<!--                                            <span class="text-primary d-block">{{item.numObj}}</span>-->
                                            <h3 class="fs-20 text-black font-w600 mb-1">{{item.nomProjet}}</h3>
                                            <span class="d-block mb-lg-0 mb-0">{{formatDate(item.datefin)}}</span>
                                        </div>
                                    </div>
                                    <div class="col-xl-2 col-xxl-2 col-lg-3 col-sm-4 mb-sm-4 col-6 mb-3">
                                        <h3 class="mb-2 d-block" style="color: black">Client</h3>
                                        <span class=" " style="color: gray">{{item.clientPro}}</span>
                                    </div>
    ...
    export default {
        ...
        methods: {
            async getData(){
                ...
                this.user = user;
                await axios.get('http://127.0.0.1:8000/getMyProjectsUser/'+user.id).then(res=>this.data = JSON.parse(res.data))
          ...
          formatDate(item){
            ...
            async AddJustificatifTR(){
                ...
                var d = {"id":this.user.id,"montant":this.montant,"justif":im};
            ...
            async AddDevis(){
                ...
                var d = {"id":this.user.id,"montant":this.montant,"justif":im,"numDevis":this.NumDevis};
            ...
            async AddFacture(){
                ...
                var d = {"id":this.user.id,"numFacture":this.NumFacture,"montant":this.montant,"justif":im,"devisFacture":this.DevisFacture};
            ...
            ShowDetails(id){
                this.$router.push({ path: 'AfficherProjet', query: { id: id } })
