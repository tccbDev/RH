				...
				<div class="row">
					<div class="col-xl-12">
						<ul class="nav nav-pills review-tab">
							<li class="nav-item">
								<a href="#navpills-1" class="nav-link active" data-toggle="tab" aria-expanded="false">Tous les projets</a>
							</li>
							<li class="nav-item">
								<a href="#navpills-2" class="nav-link" data-toggle="tab" aria-expanded="false">En cours </a>
							</li>
							<li class="nav-item">
								<a href="#navpills-3" class="nav-link" data-toggle="tab" aria-expanded="true">Terminer</a>
							</li>
						</ul>
						<div class="tab-content pt-4 bg-white">
							<div id="navpills-1" class="tab-pane active">
								...
								<div class="card review-table">
									<div class="media align-items-center">
										<img class="mr-3 img-fluid rounded" width="90" v-bind:src="'http://127.0.0.1:8000/'+item.photoPro" alt="DexignZone">
										<div class="media-body d-lg-flex d-block row align-items-center">
											<div class="col-xl-4 col-xxl-5 col-lg-12 review-bx">
												...
												<span class="d-block mb-xl-0 mb-3">{{ new Date(item.datedebut.timestamp * 1000).getFullYear()}}</span>
											</div>
										...
										<div class="media-footer d-sm-flex d-block align-items-center">
											...
											<div class="edit ml-auto">
												<button class="btn btn-outline-success rounded  mr-2" @click="ShowDetails(item.id)">Détails</button>
											</div>
										</div>
									</div>
								</div>
							...
							<div id="navpills-2" class="tab-pane">
								<div class="card review-table">
									<div class="media align-items-center">
										<img class="mr-3 img-fluid rounded" width="90" src="images/customers/3.jpg" alt="DexignZone">
										<div class="media-body d-lg-flex d-block row align-items-center">
											<div class="col-xl-4 col-xxl-5 col-lg-12 review-bx">
												<span class="text-primary d-block">#C01234</span>
										...
										<div class="media-footer d-sm-flex d-block align-items-center">
											...
											<div class="edit ml-auto">
												<button class="btn btn-outline-success rounded  mr-2" @click="ShowDetails(item.id)">Approve</button>
							...
							<div id="navpills-3" class="tab-pane">
								<div class="card review-table">
									<div class="media align-items-center">
										<img class="mr-3 img-fluid rounded" width="90" src="images/customers/2.jpg" alt="DexignZone">
										<div class="media-body d-lg-flex d-block row align-items-center">
											<div class="col-xl-4 col-xxl-5 col-lg-12 review-bx">
												<span class="text-primary d-block">#C01234</span>
	...
	export default {
		...
		methods: {
			async getData(){
				...
				let p = [];
				await axios.get('http://127.0.0.1:8000/ListeProjets').then(function (res) {
				...
				let listOfObject = Object.keys(p).map((key) => {
					return p[key]
				})
				this.data = listOfObject;
				console.log(this.data)
