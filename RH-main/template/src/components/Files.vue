                            ...
                            <ul class="navbar-nav header-right">
                                <li class="nav-item dropdown notification_dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" >
                                        <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380" v-if="role != 'Freelance' && role !='Stagiaire'">
                                            <ul class="timeline">
                                                <li>


                                                    <div class="card-body">
                                                        <button type="button" class="btn light btn-primary" @click="sendJustificatif">Envoyer justificatif de transport</button>
                                                ...
                                                <li>
                                                    <div class="card-body">
                                                        ...
                                                        <button type="button" class="btn light btn-success" @click="sendNDF">Envoyer NDF</button>
                                        ...
                                        <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380" v-if="role == 'Freelance'">
                                            <ul class="timeline">
                                                <li>


                                                    <div class="card-body">
                                                        <button type="button" class="btn light btn-primary" @click="sendDevis">Envoyer Devis</button>
                                                ...
                                                <li>
                                                    <div class="card-body">
                                                        ...
                                                        <button type="button" class="btn light btn-success" @click="sendFacture">Envoyer Facture</button>
                ...
                <div class="container-fluid">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <v-data-table @click:row="clickDevis"
                                                      :headers="headersDevis"
                                                      :items="Devis"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <v-data-table @click:row="clickFacture"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Justifs des transports</h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <div class="table-responsive">
                                            <v-data-table @click:row="clickJustifTR"
                                                          :headers="headersJustifTransport"
                                                          :items="JustifTranspor"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Liste des NDF's</h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <v-data-table @click:row="clickJustifNDF"
                                                      :headers="headersJustifNDF"
                                                      :items="NDF"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                headersDevis: [
                    ...
                    { text: 'Numéro devis', value: 'numDevis' },
                    { text: 'Date Devis', value: 'dateDevis' },
                    { text: 'Date Upload', value: 'Dateupload' },
                ...
                headersFacture: [
                    ...
                    { text: 'Montant', value: 'montant' },
                    { text: 'Numéro facture', value: 'numFacture' },
                    { text: 'Date Facture', value: 'dateFacture' },
                    { text: 'Devis Facture', value: 'devisFacture' },
                    { text: 'Date Upload', value: 'Dateupload' },
                    { text: 'Statut', value: 'statut' },

                ],
                headersJustifTransport: [
                    {
                        text: 'Salarié',
                        align: 'start',
                        filterable: false,
                ...
                headersJustifNDF: [
                    ...
                    { text: 'Montant', value: 'montant' },
                    { text: 'Nature achat', value: 'nature_achat' },
                    { text: 'Date Upload', value: 'Dateupload' },
                    { text: 'Statut', value: 'statut' },
        ...
        methods: {
            async getDataDevis(){
                let d = [];
                await axios.get('http://127.0.0.1:8000/ListeDevis').then(function (res) {
                ...
                var j = 0;
                while(j<listOfObjects.length){
                    this.Devis.push({"user":listOfObjects[j].user.username,"montant":listOfObjects[j].montant,"numDevis":listOfObjects[j].numDevis,"dateDevis":new Date(listOfObjects[j].dateDevis.timestamp * 1000).toString(),"justif":listOfObjects[j].justif,"Dateupload":new Date(listOfObjects[j].dateUpload.timestamp * 1000).toString(),"statut":listOfObjects[j].statut})
                    j++
                }
                //this.Devis = listOfObjects
                console.log(this.Devis)
            },
            async getDataFacture(){
                let d = [];
                await axios.get('http://127.0.0.1:8000/ListeFacture').then(function (res) {
                    var myObj = JSON.parse(res.data);
                    for(var i =0;i<myObj.length;i++){
                        //console.log(this.data)
                        d.push(myObj[i])
                ...
                var j = 0;
                while(j<listOfObjects.length){
                    this.Facture.push({"user":listOfObjects[j].user.username,"montant":listOfObjects[j].montant,"numFacture":listOfObjects[j].numFacture,"devisFacture":listOfObjects[j].devisFacture,"dateFacture":new Date(listOfObjects[j].dateFacture.timestamp * 1000).toString(),"justif":listOfObjects[j].justif,"Dateupload":new Date(listOfObjects[j].dateUpload.timestamp * 1000).toString(),"statut":listOfObjects[j].statut})
                    j++
                }
                //this.Devis = listOfObjects
                console.log(this.Facture)
            },
            async getDataJustifTR(){
                let d = [];
                await axios.get('http://127.0.0.1:8000/ListJustifsTR').then(function (res) {
                    var myObj = JSON.parse(res.data);
                    for(var i =0;i<myObj.length;i++){
                        //console.log(this.data)
                        d.push(myObj[i])
                ...
                var j = 0;
                while(j<listOfObjects.length){
                    this.JustifTranspor.push({"user":listOfObjects[j].user.username,"montant":listOfObjects[j].montant,"mois":listOfObjects[j].mois,"justif":listOfObjects[j].justif,"Dateupload":new Date(listOfObjects[j].dateUpload.timestamp * 1000).toString(),"statut":listOfObjects[j].statut})
                    j++
                }
                //this.Devis = listOfObjects
                console.log(this.JustifTranspor)
            },
            async getDataJustifNDF(){
                let d = [];
                await axios.get('http://127.0.0.1:8000/ListeJustifsNDF').then(function (res) {
                    var myObj = JSON.parse(res.data);
                    for(var i =0;i<myObj.length;i++){
                        //console.log(this.data)
                        d.push(myObj[i])
                ...
                var j = 0;
                while(j<listOfObjects.length){
                    this.NDF.push({"user":listOfObjects[j].user.username,"montant":listOfObjects[j].montant,"nature_achat":listOfObjects[j].natureAchat,"justif":listOfObjects[j].justif,"Dateupload":new Date(listOfObjects[j].dateUpload.timestamp * 1000).toString(),"statut":listOfObjects[j].statut})
                    j++
                }
                //this.Devis = listOfObjects
            ...
            clickDevis(item){
                window.open('http://127.0.0.1:8000/'+item.justif);
            },
            sendNDF(){
            ...
            async AddJustificatifTR(){
                ...
                var d = {"id":this.user.id,"montant":this.montant,"mois":this.mois,"justif":im};
            ...
            async AddDevis(){
                ...
                var d = {"id":this.user.id,"montant":this.montant,"dateDevis":this.date,"justif":im,"numDevis":this.NumDevis};
            ...
            async AddFacture(){
                ...
                var d = {"id":this.user.id,"numFacture":this.NumFacture,"montant":this.montant,"dateFacture":this.date,"justif":im,"devisFacture":this.DevisFacture};
        ...
        beforeMount(){
            this.getDataDevis();
            this.getDataFacture();
            this.getDataJustifTR();
            this.getDataJustifNDF();
        }
    }
    </script>
