            ...
            <div class="content-body">
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Liste des salariés</a></li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-sm mb-0 table-responsive-lg text-black">
                                            ...
                                            <tr>
                                                ...
                                                <th class="align-middle pr-7">Nom</th>
                                                <th class="align-middle minw200">Role</th>
                                                <th class="align-middle text-right">Contrat</th>
                                                <th class="align-middle text-right">NDA</th>
                                                <th class="align-middle text-right">Gérer</th>
                                                <th class="no-sort"></th>
                                            </tr>
                                            </thead>
                                            <tbody id="orders">
                                            <tr class="btn-reveal-trigger" v-for="item in list" :key="item.id">
                                                <td class="py-2">
                                                ...
                                                <td class="py-2 text-right" v-if="item.statut === 'Signed'">
                                                ...
                                                <td class="py-2 text-right" v-if="item.statut !== 'Signed'">
                                                    <span class="badge badge-danger">Pending<span
                                                            class="ml-1 fa fa-power-off"></span></span>
                                                </td>
                                                <td class="py-2 text-right" v-if="item.nda === 'Signed'">
                                                    <span class="badge badge-success">{{item.statut}}<span
                                                            class="ml-1 fa fa-check"></span></span>
                                                </td>
                                                <td class="py-2 text-right" v-if="item.nda !== 'Signed'">
                                                ...
                                                <td class="py-2 text-right" v-if="item.statut !== 'Signed'">
                                                    <button @click="sign(item.id)">
                                                    <span
                                                            class="ml-1 fa fa-pencil"></span>
                                                    </button>
                                                </td>
                                            </tr>
                                            </tbody>
    ...
    export default {
        ...
        methods: {
            async getData(){
                ...
                let d = [];
               await axios.get('http://127.0.0.1:8000/AllSalarie').then(function (res) {
            ...
            async sign(id){
                await axios.get('http://localhost:8000/signContract/'+id).then(res=>console.log(res.data))
                await axios.get('http://localhost:8000/signNDA/'+id).then(res=>console.log(res.data))
            }
        },
        beforeMount() {
            this.getData()
