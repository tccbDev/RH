										...
										<form> 
											...
											<div class="form-row">
												...
												<div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Nom jeune fille" v-model="nom_j_f">

                                                    </div>
                                                    <div class="form-group col-md-6">
                                                    <label>Date de naissance</label>
													<input type="date" class="form-control" placeholder="" v-model="dateNais">
											</div>
                                            </div>
                                            <div class="form-row">
											<div class="form-group col-md-6">
                                                    ...
                                                    <option selected  value="oui">Homme</option>
                                                    <option value="non" selected>Femme</option>
                                                    >
                                            </select>
											</div>
											<div class="form-group col-md-6">
													<label>Adresse</label>
                                                    <input type="text" class="form-control" placeholder="Exemple..." v-model="adresse">
											</div>
                                            </div>
                                            <div class="form-row">
											<div class="form-group col-md-2">
													<input type="text" class="form-control" placeholder="Code Postal" v-model="codeP">
												</div>
                                            <div class="col-sm-5 mt-2 mt-sm-0">
                                                <input type="text" class="form-control" placeholder="Ville" v-model="ville">
                                            </div>
                                            <div class="col-sm-5 mt-2 mt-sm-0">
											...
											<div class="form-group col-md-4">
                                                 <label>Telephone</label>
													<input type="text" class="form-control" placeholder="Telephone" v-model="tel">
												</div>
                                            <div class="col-sm-4 mt-2 mt-sm-0">
                                                 <label>Telephone portable</label>
                                                <input type="text" class="form-control" placeholder="Telephone portable" v-model="telpor">
                                            </div>
                                            <div class="col-sm-4 mt-2 mt-sm-0">
                                                 <label>Email</label>
                                            ...
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <label>Dernière école fréquentée</label>
                                                <input type="text" class="form-control" placeholder="Dernière école fréquentée" v-model="der_ecole_freq">
                                            </div>
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <label>Diplome</label>
                                                <input type="text" class="form-control" placeholder="Diplome" v-model="der_diplome">
                                            </div>							
                                            </div>
                                            <br>
                                            <div class="form-row">
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <label>Indiquez si vous acceptez ou refusez la déduction forfaitaire en matière sociale</label>
                                              <select id="role" class="form-control" v-model="forfaitaire_soc">
                                                    <option selected value="accepte">J'ACCEPTE</option>
                                                    <option value="refuse" selected>JE REFUSE</option>
                                                    <option value="jammais">Je ne suis pas prévu(e) sur un long métrage</option>
                                            </select>
                                            </div>
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <label>Déclaration des impôts en France ? *</label>
                                                 <br>
                                            <label class="radio-inline mr-3"><input type="radio" name="optradio" v-model="dec_impo" value="oui"> Oui</label>
                                            <label class="radio-inline mr-3"><input type="radio" name="optradio" v-model="dec_impo" value="non" > Non</label>	
                                            </div>							
                                            </div>
                                            <br>
                                            <div class="form-row">
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                              ...
                                              <select id="sit_familiale" class="form-control" v-model="sit_familiale">
                                            ...
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <label>Nombre de personne à charge </label>
                                                <input type="text" class="form-control" placeholder="Nombre de personne à charge" v-model="nbr_per_charge">
                                            </div>							
                                            </div>
                                            <br>
                                            <div class="form-row">
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                ...
                                                <input type="text" class="form-control" placeholder="Nombre d'enfant" v-model="nbr_enfant">
                                            </div>
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <label>N.I.R.P.P </label>
                                                <input type="text" class="form-control" placeholder="Numéro de sécurité sociale" v-model="num_sec_soc">
                                            </div>							
                                            </div>
                                            <br>
                                            <div class="form-row">
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                ...
                                                <input type="text" class="form-control" placeholder="Lieu de Naissance" v-model="lieu_nais">
                                            </div>
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <label>Nationalité</label>
                                                
                                                <select class="form-control"  v-model="nationalite">
                                                        ...
                                                        <option select value="USA">Americaine (États-Unis)</option>
                                            ...
                                            <div class="form-row">
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                  <label>N°carte de séjour </label>
                                                <input type="text" class="form-control" placeholder="N°carte de séjour" v-model="num_carte_sej">
                                            </div>
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <label>Date de validité </label>
                                                <input type="date" class="form-control"  v-model="dat_val">
                                            </div>							
                                            </div>
                                            <div class="form-row">
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                  <label>Etes-vous à la retraite ? </label>
                                              <select id="sit_familiale" class="form-control" v-model="retraite">
                                            ...
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <label>IBAN  </label>
												<input type="text" class="form-control" placeholder="IBAN " v-model="iban">
                                            </div>							
                                            </div>
                                            <div class="form-row">
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                  <label>Si oui, êtes-vous retraité Audiens ? </label>
                                              <select id="sit_familiale" class="form-control" v-model="audiens_retraite">
                                                    <option selected  value="oui">Oui</option>
                                                    <option value="non" selected>Non</option>
                                                    <option value="non" selected>Pas retraité</option>
                                            </select>
                                            </div>
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <label>N° Congés spectacle </label>
                                                <input type="text" class="form-control" placeholder="N° Congés spectacle" v-model="num_conge_spec">
                                            </div>							
                                            </div>
                                            <br>
                                            <div class="form-row">
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                  <label>Date de la dernière visite médicale : </label>
                                              <input type="date" class="form-control" placeholder="" v-model="date_med">
                                            </div>
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <label>Reconnaissance qualité travailleur handicapé ? </label>
                                                <select id="sit_familiale" class="form-control" v-model="handicap">
                                                    <option selected  value="oui">Oui</option>
                                                    <option value="non" selected>Non</option>
                                            </select>
                                            </div>							
											...
											<div class="form-group col-md-5">
                                                 <label>Adresse de votre centre de Sécurité Sociale  </label>
												<input type="text" class="form-control" placeholder="Adresse de votre centre de Sécurité Sociale " v-model="adresse_sec_soc">
												</div>
                                            <div class="col-sm-2 mt-2 mt-sm-0">
                                                 <label>Code postal Sécurité Sociale </label>
                                                <input type="text" class="form-control" placeholder="Code postal Sécurité Sociale" v-model="codeP_sec_soc">
                                            </div>
                                            <div class="col-sm-5 mt-2 mt-sm-0">
                                                 <label>Ville</label>
                                                <input type="text" class="form-control" placeholder="Ville" v-model="ville_sec_soc">
                                            </div>							
                                            </div>
                                            <br>
                                           
                                            <h6>Coordonnées de la personne à prévenir en cas d'accident </h6>
                                            <div class="form-row">
											<div class="form-group col-md-4">
                                                 <label>NOM Prénom  </label>
												<input type="text" class="form-control" placeholder="NOM Prénom " v-model="nom_pers_urg">
												</div>
                                            <div class="col-sm-4 mt-2 mt-sm-0">
                                                 <label>Adresse</label>
                                                <input type="text" class="form-control" placeholder="Adresse" v-model="pers_adr_urg">
                                            </div>
                                            <div class="col-sm-4 mt-2 mt-sm-0">
                                                 <label>N° de téléphone</label>
                                                <input type="text" class="form-control" placeholder="N° de téléphone" v-model="pers_num_urg">
                                            </div>							
                                            </div>
                                           <br>
                                            <h5>Fichier à joindre</h5>
                                            <div class="form-row">
                                            <div class="col-sm-6 mt-2 mt-sm-0">

                                                <input type="file" class="custom-file-input" @change="previewFiles">
                                                <label class="custom-file-label">Copie de votre carte d'identité recto et verso ou de votre passeport </label>
                                            </div>
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <input type="file" class="custom-file-input" @change="previewFiles">
                                                 <label class="custom-file-label">Copie de diplome ou une copie de votre relevé de note</label>
                                            </div>							
                                            </div>
                                            <br>
                                            ...
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                ...
                                                <input type="file" class="custom-file-input"  @change="previewFiles">
                                                <label class="custom-file-label">Copie de votre carte vitale  </label>
                                            </div>
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <input type="file" class="custom-file-input" @change="previewFiles">  
                                                 <label class="custom-file-label">Copie de l'attestation de visite médicale à jour</label>
                                            </div>							
                                            </div>
                                            <br>
                                            <div class="form-row">
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                ...
                                                <input type="file" class="custom-file-input" @change="previewFiles">
                                                <label class="custom-file-label">Copie de votre RIB   </label>
                                            </div>
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                 <input  type="file"  class="custom-file-input" @change="previewFiles"  >
                                                 <label class="custom-file-label">Une photo récente</label>
                                            </div>							
                                            </div>
                                            <br>
                                            
                                            
<input type="text" class="form-control" placeholder="" id="image" v-model="copiecin" hidden>
<input type="text" class="form-control" placeholder="" id="image" v-model="cartevit" hidden>
<input type="text" class="form-control" placeholder="" id="image" v-model="rib" hidden>
<input type="text" class="form-control" placeholder="" id="image" v-model="copdip" hidden>
<input type="text" class="form-control" placeholder="" id="image" v-model="attmed" hidden>
<input type="text" class="form-control" placeholder="" id="image" v-model="photorec" hidden>


											<button type="button" class="btn btn-primary" @click="clickButton">créer</button>
										</form>
									</div>
								</div>
							</div>
    ...
    methods: {   
        ...
        async clickButton(){
            if(this.nom=="")
                    ...
                    alert("prenom");
            else if (this.nom_j_f=="")
                    alert("nom_j_f");
            else if (this.dateNais=="")
                    alert("dateNais");
            else if (this.gender=="")
                    alert("gender");
            else if (this.nomCli=="")
                    ...
                    alert("email");
            else if (this.der_ecole_freq=="")
                    alert("der_ecole_freq");
            else if (this.der_diplome=="")
                    alert("der_diplome");
            else if (this.forfaitaire_soc=="")
                    alert("forfaitaire_soc");
            else if (this.dec_impo=="")
                    alert("dec_impo");
            else if (this.sit_familiale=="")
                    alert("sit_familiale");
            else if (this.nbr_per_charge=="")
                    alert("nbr_per_charge");
            else if (this.nbr_enfant=="")
                    alert("nbr_enfant");
            else if (this.num_sec_soc=="")
                    alert("num_sec_soc");
            else if (this.lieu_nais=="")
                    alert("lieu_nais");
            else if (this.nationalite=="")
                    alert("nationalite");
            else if (this.num_carte_sej=="")
                    alert("num_carte_sej");
            else if (this.dat_val=="")
                    alert("dat_val");
            else if (this.retraite=="")
                    alert("retraite");
            else if (this.iban=="")
                    alert("iban");
            else if (this.audiens_retraite=="")
                    alert("audiens_retraite");
            else if (this.num_conge_spec=="")
                    alert("num_conge_spec");
            else if (this.date_med=="")
                    alert("date_med");
            else if (this.handicap=="")
                    alert("handicap");
            else if (this.adresse_sec_soc=="")
                    alert("adresse_sec_soc");
            else if (this.codeP_sec_soc=="")
                    alert("codeP_sec_soc");
            else if (this.ville_sec_soc=="")
                    alert("ville_sec_soc");
            else if (this.nom_pers_urg=="")
                    alert("nom_pers_urg");
            else if (this.pers_adr_urg=="")
                    alert("pers_adr_urg");
            else if (this.pers_num_urg=="")
                    alert("pers_num_urg");
            ...
            var data = {"nom":this.nom,"prenom":this.prenom,"nom_j_f":this.nom_j_f,"dateNais":this.dateNais,"nomCli":this.nomCli,
            "adresse":this.adresse,"codeP":this.codeP,"ville":this.ville,"tel":this.tel,"telpor":this.telpor,
            "email":this.email,"der_ecole_freq":this.der_ecole_freq,"der_diplome":this.der_diplome,"forfaitaire_soc":this.forfaitaire_soc,"dec_impo":this.dec_impo,
            "sit_familiale":this.sit_familiale,"nbr_per_charge":this.nbr_per_charge,"nbr_enfant":this.nbr_enfant,"num_sec_soc":this.num_sec_soc,"lieu_nais":this.lieu_nais,
            "nationalite":this.nationalite,"num_carte_sej":this.num_carte_sej,"dat_val":this.dat_val,"retraite":this.retraite,"iban":this.iban,
             "audiens_retraite":this.audiens_retraite,"num_conge_spec":this.num_conge_spec,"date_med":this.date_med,"handicap":this.handicap,"adresse_sec_soc":this.adresse_sec_soc,
             "codeP_sec_soc":this.codeP_sec_soc,"ville_sec_soc":this.ville_sec_soc,"nom_pers_urg":this.nom_pers_urg,"pers_adr_urg":this.pers_adr_urg,"pers_num_urg":this.pers_num_urg,
             "id":this.data.id,"gender":this.gender,
             
            }


            await axios.post('http://localhost:8000/EditUser',data,options).then(res=>this.data=res.data.toString())
